...
export default function Contact() {
    const [isHoveringEmail, handleMouseOverEmail, handleMouseOutEmail] = useHovering();

    const [isHoveringContact, handleMouseOverContact, handleMouseOutContact] = useHovering();
    ...
    return (
        <div onMouseOver={handleMouseOverContact}
            ...
            <Wave />
            <Eyes shut={!isHoveringContact}
                surprised={isHoveringEmail} />
            <Info />
