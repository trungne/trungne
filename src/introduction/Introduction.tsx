...
import CurvyDivider from "../CurvyDivider/CurvyDivider";
function MyAvatar() {
    return (
...
export default function Introduction() {
    return (
        <div id="introduction" style={{position: "relative"}} className={styles["introduction"]}>
            <div className={styles['custom-shape-divider-top-1644338118']}>
